...
public class DsClient {
     ...
     */
    void processJob(DsClient dsClient, String resp) throws Exception {
        ...
        resp=reader.readLine();
        cSendLine(Commands.SCHD.getDescription() + " " + jobSubmission.jobID + " " + serversList.get(0).type + " 0");
        resp=reader.readLine();
    }
    /*
     *  Main loop

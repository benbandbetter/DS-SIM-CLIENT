    ...
    public void jobSchedule(JobSubmission jobSubmission, List<ServerStatus> lServer ) throws Exception {
        switch (algorithmMode) {
            ...
            case "LRR":
                ...
                String maxServerType=serversList.get(0).type;
                result=lServer.stream().filter( (ServerStatus a) -> a.type.equals(maxServerType)).collect(Collectors.toList());
                System.out.println("====Sort LRR====");
